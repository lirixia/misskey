...
export type Ep__AdminRootAddRequest = operations['ep___admin_root_add']['requestBody']['content']['application/json'];
export type Ep__AdminRootRemoveRequest = operations['ep___admin_root_remove']['requestBody']['content']['application/json'];
export type Ep__FollowingHistoryRequest = operations['ep___following_history']['requestBody']['content']['application/json'];
export type Ep__FollowingHistoryResponse = operations['ep___following_history']['responses']['200']['content']['application/json'];
export type Ep__FollowingRequestsHistoryRequest = operations['ep___following_requests_history']['requestBody']['content']['application/json'];
export type Ep__FollowingRequestsHistoryResponse = operations['ep___following_requests_history']['responses']['200']['content']['application/json'];
