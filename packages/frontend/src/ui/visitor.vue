...
<template>
	<div class="mk-app">
		<a v-if="isRoot" href="https://github.com/catsmiry/misskey" target="_blank" class="github-corner"
		...
		<div class="main">
			<div v-if="!isRoot" class="header">
				<div v-if="narrow === false" class="wide">
					...
					<MkA to="/channels" class="link" activeClass="active"><i class="ti ti-device-tv icon"></i> {{ i18n.ts.channel
						}}</MkA>
				</div>
		...
		<Transition :name="'tray-back'">
			<div v-if="showMenu" class="menu-back _modalBg" @click="showMenu = false" @touchstart.passive="showMenu = false">
			</div>
		</Transition>
		...
		<Transition :name="'tray'">
			<div v-if="showMenu" class="menu">
				...
				<div class="action">
					<button v-vibrate="defaultStore.state.vibrateSystem ? 5 : []" class="_buttonPrimary" @click="signup()">{{
						i18n.ts.signup }}</button>
					<button v-vibrate="defaultStore.state.vibrateSystem ? 5 : []" class="_button" @click="signin()">{{
						i18n.ts.login }}</button>
				</div>
			</div>
		</Transition>
	</div>
